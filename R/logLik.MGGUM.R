#' @describeIn logLik-class MGGUM model: polytomous unfolding responses with
#'   per-item block-structured quadrature evaluation.
#' @export
logLik.MGGUM <- function(object, theta.low = NULL, theta.up = NULL, L = NULL,
                         ...) {
  ...
  prob <- model.MGGUM(grid$theta.norm, par)
