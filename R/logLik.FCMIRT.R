#' @describeIn logLik-class FCMIRT model: forced-choice block pattern
#'   probabilities with multivariate normal quadrature.
#' @export
logLik.FCMIRT <- function(object, theta.low = NULL, theta.up = NULL, L = NULL,
                          ...) {
  ...
  prob <- model.FCMIRT(grid$theta.norm, par, patterns.total, patterns)
